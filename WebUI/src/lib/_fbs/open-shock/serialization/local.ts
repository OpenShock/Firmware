...
export { GatewayPairCommand } from './serialization/local/gateway-pair-command.js';
export { GatewayUnpairCommand } from './serialization/local/gateway-unpair-command.js';
