...
export function unionToDeviceToLocalMessagePayload(
  ...
  accessor: (obj:ErrorMessage|ReadyMessage|WifiNetworkConnectedEvent|WifiNetworkDisconnectedEvent|WifiNetworkDiscoveredEvent|WifiNetworkLostEvent|WifiNetworkRemovedEvent|WifiNetworkSavedEvent|WifiNetworkUpdatedEvent|WifiScanStatusMessage) => ErrorMessage|ReadyMessage|WifiNetworkConnectedEvent|WifiNetworkDisconnectedEvent|WifiNetworkDiscoveredEvent|WifiNetworkLostEvent|WifiNetworkRemovedEvent|WifiNetworkSavedEvent|WifiNetworkUpdatedEvent|WifiScanStatusMessage|null
): ErrorMessage|ReadyMessage|WifiNetworkConnectedEvent|WifiNetworkDisconnectedEvent|WifiNetworkDiscoveredEvent|WifiNetworkLostEvent|WifiNetworkRemovedEvent|WifiNetworkSavedEvent|WifiNetworkUpdatedEvent|WifiScanStatusMessage|null {
