...
constexpr bool test_spanToUT16() {
  uint16_t u16 = 0;
  return spanToUT("65535"_sv, u16) && u16 == 65'535;
}
...
constexpr bool test_spanToUT32() {
  uint32_t u32 = 0;
  return spanToUT("4294967295"_sv, u32) && u32 == 4'294'967'295U;
}
...
constexpr bool test_spanToUT64() {
  uint64_t u64 = 0;
  return spanToUT("18446744073709551615"_sv, u64) && u64 == 18'446'744'073'709'551'615ULL;
}
...
constexpr bool test_spanToST16() {
  int16_t i16 = 0;
  return spanToST("32767"_sv, i16) && i16 == 32'767;
}
...
constexpr bool test_spanToST32() {
  int32_t i32 = 0;
  return spanToST("-2147483647"_sv, i32) && i32 == -2'147'483'647;
}
...
constexpr bool test_spanToST64() {
  int64_t i64 = 0;
  return spanToST("9223372036854775807"_sv, i64) && i64 == 9'223'372'036'854'775'807LL;
}
