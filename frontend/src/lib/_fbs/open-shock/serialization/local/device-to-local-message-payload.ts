...
import { WifiGotIpEvent } from '../../../open-shock/serialization/local/wifi-got-ip-event.js';
import { WifiLostIpEvent } from '../../../open-shock/serialization/local/wifi-lost-ip-event.js';
